var demo = {};
var centerX = 1024/2, centerY = 576/2, ship, boss, speed = 4, boss_life = 20, ship_life = 5, max_ship_life = 5, title, missle = false, laser = true, shield = false, burst = false, counter = 0, nova_life = 2, start_boss_life = 20, nova;
demo.menu = function(){};
demo.menu.prototype = {
    preload: function(){
