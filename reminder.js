...
demo.reminder.prototype = {
    ...
    create: function(){
        ...
        if (missle == true){
            ...
            text = game.add.text(32, 75, 'Q', {fontSize: 20 + 'px', fill: '#00FFFF'});
        }
        if (laser == true){
            lase = game.add.sprite(332, 32, 'laser');
            text = game.add.text(332, 75, 'E', {fontSize: 20 + 'px', fill: '#00FFFF'});
        }
        if (shield == true){
            bub = game.add.sprite(632, 32, 'bubble_shield');
            text = game.add.text(632, 75, 'SHIFT', {fontSize: 20 + 'px', fill: '#00FFFF'});
        }
        if (burst == true){
            wav = game.add.sprite(932, 32, 'burst');
            text = game.add.text(932, 75, 'F', {fontSize: 20 + 'px', fill: '#00FFFF'});
        }
    },
    update: function(){
